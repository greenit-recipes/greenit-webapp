...
export const Navbar: React.FC = () => {
    ...
    const [showSearchBar, setShowSearchBar] = useState<boolean>(location.pathname !== RouteName.accueil && location.pathname !== RouteName.recipes)
    ...
    return (
        <div className="flex flex-row h-16 w-full | sticky top-0 bg-white z-50">
            ...
            {showSearchBar && <div className="flex flex-row w-1/5 lg:w-2/5 h-full items-center mr-12">
                <SearchBar keyId="searchBarNav"
            ...
            <div className={`grid items-center w-${showSearchBar ? '1/4' : '3/5'} justify-self-end`}>
