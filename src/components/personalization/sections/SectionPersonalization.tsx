    ...
    <div>
      <div className="flex flex-col md:flex-row md:justify-center md:space-x-24 msm:space-y-3 mx-10 mb-5">
        <div className="md:flex md:flex-col items-center">
          <h4 className="text-lg font-normal md:mb-2">Mon type de peau</h4>
          <div className="flex">
            <span className="text-sm font-light text-white py-1 px-2 bg-green rounded-lg">
              {particularities.skinType}
            </span>
          </div>
        </div>
        <div className="md:flex md:flex-col items-center">
          <h4 className="text-lg font-normal md:mb-2">Mon type de cheveux</h4>
          <div className="flex">
            <span className="text-sm font-light text-white py-1 px-2 bg-green rounded-lg">
        ...
        <div className="md:flex md:flex-col items-center">
          <h4 className="text-lg font-normal md:mb-2">Mes particularités</h4>
