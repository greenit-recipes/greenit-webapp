  ...
  return (
    <div>
      ...
      <Modal onClose={() => setShowModal(false)} show={showModal}>
        <div className="flex flex-col justify-center items-center space-y-5 -mt-4 mx-3">
          ...
          <div className="flex flex-col items-center space-y-3 text-darkBlue | leading-5">
            <div className="flex items-center space-x-3">
              <span className="flex items-center justify-center w-7 h-7 bg-darkBlue text-white rounded-full">
                2
              </span>
            ...
            <i className="bx bxs-lemon text-4xl text-blue"></i>
            <p>
