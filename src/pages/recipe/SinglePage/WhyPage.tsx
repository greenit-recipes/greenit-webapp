    ...
    <div className="h-auto w-full">
      ...
      <div className="w-full h-auto p-6 md:p-20 | flex flex-col items-center justify-center">
        <div className="flex flex-col md:flex-row w-full">
          <h2 className="text-center md:text-right">Pour la petite histoire</h2>
        ...
        <p className="text-center md:text-left mt-4">
          ...
          maison.
          <br /> <br /> Ces derniers s’entourent d’étudiants qui apportent leurs
          pierres à l’édifice en proposant un design, une identité de marque et
          leur aide pour développer le premier site internet lancé en juin 2021.
          L’équipe s’agrandit à nouveau en novembre 2021 pour accueillir Florian
          qui est venu booster les ambitions de Greenit en apportant son
          savoir-faire.
        </p>
      </div>
      <div className="w-full h-auto p-6 bg-yellowL | flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10 md:w-1/2">
          ...
          <div>
            <h1 className="text-center text-yellow font-diy text-5xl">78 %</h1>
            <p className="text-center">
      ...
      <div className="relative">
        <div className="absolute -top-16 right-2 md:right-10">
          <img
      ...
      <div className="w-full h-auto p-2 bg-greenL | grid grid-cols-1 md:grid-cols-3 items-center justify-center md:px-20 md:py-10">
        ...
        <p className="my-14 text-center font-diy text-3xl">et ça continue !</p>
      </div>
