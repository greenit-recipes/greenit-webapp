...
export const HeaderRecipe: React.FC<IHeaderRecipe> = ({ className, recipe }) => {
  const user = null;
  return (
    <div className="fixed z-0 grid justify-items-center w-full pb-20 bgColorHeaderRecipe">
      <div className="fontQSbold text-3xl mt-20">Alicds</div>
      <div className="fontQSregular text-lg	mb-3">Créateur.ice</div>
      <div className="w-3/6 mr-7 flex fontQSmedium  mb-8">
                            <UserBadge
        ...
        <div className="flex items-center">
          ...
          DIY, conseils, bien-être 🌿 conseils personnalisés{" "}
          🍃 conseillère en aroma-phytothérapie sur Aix en Provence 🌻 recettes, DIY, conseils, bien-être 🌿 conseils personnalisés

        </div>
      </div>
      <div className="mb-7">
        <div className="flex mr-3 pt-2 pb-2 pl-2 pr-4 bg-white rounded fontQSmedium text-lg	">
          <img
