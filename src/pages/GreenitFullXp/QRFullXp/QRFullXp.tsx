...
const QRFullXp = () => {
    ...
    return (
      ...
      <div className="h-screen flex flex-col text-center">
        ...
        <h2 className="text-green text-xl font-semibold mt-10 mb-4 md:mt-20 md:text-2xl">
          Bienvenu.e !
        </h2>
        <h1 className="text-2xl font-semibold mx-8 mb-3">
          C’est le moment de se lancer dans le fait-maison !
        </h1>

        <h3 className="text-base font-medium mx-8 mb-6">
          Retrouve les recettes ainsi que la video d’accompagnement dans ton
          profil👇
        </h3>
        ...
        <div className="mt-8 font-medium text-sm md:text-base">
          Vos 3 produits 100% Made in chez vous 🙂
        </div>
      </div>
    </>
  );
