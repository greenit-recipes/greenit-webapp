  ...
  return (
    <div>
      <Helmet>
        ...
        <title>
          Accompagnement de ta box Premiers Pas : vidéos et recettes DIY |
          Greenit Community
        </title>
        ...
        {!isMobile && (
          <div className="relative flex ml-20">
            ...
            <h3 className="absolute top-full right-0 text-xs w-56 text-center">
              Qu’as-tu pensé de tes premiers pas en DIY ? Vote pour la prochaine
              box !
            </h3>
          </div>
        )}
          ...
          {isMobile && (
            <div className="relative w-4/5">
              ...
              <h3 className="absolute top-3/4 right-0 mt-6 mr-2 text-xs w-56 text-center">
                Qu’as-tu pensé de tes premiers pas en DIY ? Vote pour la
                prochaine box !
              </h3>
            </div>
          )}
