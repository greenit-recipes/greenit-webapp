...
export const MenuMultiSelect: React.FC<MenuMultiSelect> = ({
  ...
  const updateBrandinfo = (brandInfo: string) => {
    switch (brandInfo) {
      ...
      case "Greenit Community":
        return "Greenit Community est la première communauté autour du DIY. Nous centralisons plus de 300 recettes sur la plateforme qui viennent de la communauté : des passionnées de cosmétiques maison, des cosmétologues, des aromathérapeutes et des expertes en DIY. Notre mission est de rendre la consommation du fait-maison plus accessible en créant tout un écosystème pour faciliter une production artisanale. La consommation et production maison permettent de prendre soin de soi sans s’abîmer et en réduisant l’impact sur l’environnement. Pour la création de cet écosystème nous reposons sur une communauté de personnes engagées, nous co-construisons la plateforme et nous permettons à des milliers d’autres de se lancer !.";
      default:
