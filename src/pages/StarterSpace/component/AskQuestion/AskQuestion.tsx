...
export const AskQuestion: React.FC = () => {
  ...
  return (
    <div className="flex flex-col self-center mb-20 justify-items-center w-full lg:w-96">
      ...
      >
        <textarea
          className="bg-white shadow-flat border-1 focus:outline-none | rounded-md p-4"
        ...
        <input
          className="h-12 bg-white rounded-md shadow-flat border-1 focus:outline-none | p-4"
